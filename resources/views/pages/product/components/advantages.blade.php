    ...
    <div class="content">
        <div class="row">
            <div class="col text-center mb-3">
                ...
                <h3 class="advantages__label">96% клиентов остаются с нами</h3>
            </div>
            <div class="col text-center mb-3">
                ...
                <h3 class="advantages__label">Цены ниже рыночных на 15%</h3>
            </div>
            <div class="col text-center mb-3">
                ...
                <h3 class="advantages__label">Оценка клиентов нашего интернет-магазина 9,5/10</h3>
            </div>
        </div>
    </div>
</section>
